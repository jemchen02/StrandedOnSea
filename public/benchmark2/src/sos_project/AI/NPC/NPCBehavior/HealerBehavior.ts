...
export default class HealerBehavior extends NPCBehavior  {
    ...
    public initializeAI(owner: NPCActor, opts: Record<string, any>): void {
        ...
        healAlly.targetFinder = new BasicFinder<Battler>(ClosestPositioned(this.owner), BattlerActiveFilter(), AllyFilter(this.owner), BattlerHealthFilter(0,this.owner.maxHealth/2));
